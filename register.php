...
<head>
    ...
    <title>Înregistrare — chromeVault</title>
...
<div class="auth-page">
    <div class="auth-container">
        ...
        <h2>Creare Cont</h2>
        <p class="auth-subtitle">Completează formularul pentru a-ți crea un cont.</p>
        ...
        <form action="php/auth.php" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username"
                       placeholder="ex: ion_popescu" required
                       value="<?= isset($_GET['error']) ? htmlspecialchars($_POST['username'] ?? '') : '' ?>">
            </div>
            ...
            <div class="form-group">
                <label for="password">Parolă <span style="color:var(--text-tertiary); font-weight:400; text-transform:none;">(minim 6 caractere)</span></label>
            ...
            <button type="submit" class="btn btn-primary btn-full">Înregistrează-te</button>
        </form>
